...
const CreateAdminUI = (ip_server) => {
	...
	function Inicilizar(){
		...
		console.log("MSGAdm completo:", MSGAdm);
		console.log("MSGAdm['lscreens']:", MSGAdm["lscreens"]);
		document.getElementById("msgdefects").innerHTML = MSGAdm["lscreens"];
		console.log("msgdefects después:", document.getElementById("msgdefects").innerHTML);
